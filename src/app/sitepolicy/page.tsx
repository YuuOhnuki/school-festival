        ...
        <div className="w-full max-w-7xl mx-auto py-5 px-4">
            ...
            <div className="flex flex-col gap-4">
                <div>
                    ...
                    <p className="text-sm font-extralight py-2 pl-2 leading-5">
                ...
                <div>
                    ...
                    <ul className="list-disc text-sm font-extralight py-2 pl-6 leading-5">
                ...
                <div>
                    ...
                    <p className="text-sm font-extralight py-2 pl-2 leading-5">
                        ...
                        <br />
                        Eメールアドレス：[ここにあなたの連絡先メールアドレスを記入してください]
                    </p>
                </div>
            </div>
        </div>
